...
Evaluate the provided "Retrieved DMRS Evidence" (top matched DMRS-Q items from the handbook) to see if one applies best. Reason through their applicability.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--test",
        type=str,
        default="final_mapped_data_with_weights_directvote.json",
