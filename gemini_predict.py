...
class DefensePrediction(BaseModel):
    ...
    label: int = Field(
        description="The integer label of the defense mechanism tier (0-8)."
    )
...
# ==============================================================================
# In a real scenario, you'd load the handbook text from a file.
HANDBOOK_TEXT = """
...
4. Output strict JSON matching the requested schema. Reason step-by-step before selecting the label.
"""
...
def annotate_dataset(input_json_path: str, output_json_path: str):
    ...
    for item in data:
        ...
        try:
            # Note: For production with >32k tokens, use client.caches.create() instead
            # of passing system_instruction here to save massive token costs.
            response = client.models.generate_content(
                model="gemini-2.5-flash",  # Flash is highly capable for this and cost-effective
